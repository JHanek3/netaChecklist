...
class TestIntegration(unittest.TestCase):
    ...
    def testLoadBanks(self):
        ...
        newPost = postRequest(ticket, projectID, checklistTemplate[os.getenv("CHECKLIST_NAME")], workbook["B3F ID"][0], "OK_TO_DELETE", "", company, areaID, workbook["Inspection Date"][0], workbook["QAQC Authority"][0], workbook["Inspection Attendees"][0])
